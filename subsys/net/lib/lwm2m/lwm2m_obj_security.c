...
static u8_t  bootstrap_flag[MAX_INSTANCE_COUNT];
...
static struct lwm2m_engine_obj_field fields[] = {
	...
	OBJ_FIELD_DATA(SECURITY_MODE_ID, W, UINT),
	...
	OBJ_FIELD_DATA(SECURITY_SHORT_SERVER_ID, W, UINT)	/* TODO */
};
...
static int lwm2m_security_init(struct device *dev)
{
	...
	ret = engine_create_obj_inst(LWM2M_OBJECT_SECURITY_ID, 0, obj_inst);
	if (ret < 0) {
